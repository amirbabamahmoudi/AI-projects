...
def alpha_beta_search(board, depth, alpha, beta, maximizingPlayer):
    ...
    if maximizingPlayer:
        return max_value(board , depth , alpha , beta , valid_locations)

    else:  # Minimizing player
        return min_value(board , depth , alpha , beta , valid_locations)

def max_value(board , depth , alpha , beta , valid_locations):
    value = -math.inf
...
def min_value(board , depth , alpha , beta , valid_locations):
    value = math.inf
    column = random.choice(valid_locations)
    for col in valid_locations:
        row = first_valid_row(board, col)
...
while not game_over:
    ...
    if turn == AI and not game_over:
        ...
        col, alpha_beta_search_score = alpha_beta_search(board, 4, -math.inf, math.inf, True)
